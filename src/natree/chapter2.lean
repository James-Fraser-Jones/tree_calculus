...
namespace chapter2
  ...
  example : (M⬝M⬝X⬝X⬝X⬝X⬝V⬝I⬝I) + (M⬝C⬝C⬝V) =ᵣ M⬝M⬝M⬝C⬝C⬝L⬝I⬝I := begin
    ...
    symmetry,
    apply roman.eq_r.assoc,
    transitivity, --remove next
    apply roman.eq_r.congr,
    symmetry,
    apply roman.eq_r.assoc,
    refl,
    transitivity, --remove final
    apply roman.eq_r.congr,
    apply roman.eq_r.congr,
    symmetry,
    apply roman.eq_r.assoc,
    ...
    --move m into place
    transitivity, --remove 3 rightmost letters
    apply roman.eq_r.congr,
    apply roman.eq_r.congr,
    apply roman.eq_r.congr,
    { transitivity, --swap I⬝M to M⬝I and remove I
      apply roman.eq_r.assoc,
      transitivity,
      apply roman.eq_r.congr,
      refl,
      apply roman.eq_r.comm,
      transitivity,
      symmetry,
      apply roman.eq_r.assoc,
      apply roman.eq_r.congr,
      { transitivity, --repeat process
        apply roman.eq_r.assoc,
        transitivity,
        apply roman.eq_r.congr,
        refl,
    ...
    repeat {refl},
    --move c into place
    transitivity, --remove 1 rightmost letters
    apply roman.eq_r.congr,
    { transitivity,
      apply roman.eq_r.assoc,
      transitivity,
